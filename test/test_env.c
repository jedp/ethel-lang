...
void test_env_init() {
  ...
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "pie")->type);
}
...
void test_env_put_get() {
  ...
  TEST_ASSERT_EQUAL(TYPE_NIL, not_found->type);
...
void test_env_scopes() {
  ...
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "three-4")->type);
  ...
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "two-3")->type);
  TEST_ASSERT_EQUAL(2.2, get_env(&env, "two-2")->floatval);
  TEST_ASSERT_EQUAL(2.1, get_env(&env, "two-1")->floatval);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "one-4")->type);
  ...
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "three-4")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "three-3")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "three-2")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "three-1")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "two-3")->type);
  TEST_ASSERT_EQUAL(2.2, get_env(&env, "two-2")->floatval);
  TEST_ASSERT_EQUAL(2.1, get_env(&env, "two-1")->floatval);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "one-4")->type);
  ...
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "three-1")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "two-3")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "two-2")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "two-1")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "one-4")->type);
  TEST_ASSERT_EQUAL(1.3, get_env(&env, "one-3")->floatval);
  TEST_ASSERT_EQUAL(1.2, get_env(&env, "one-2")->floatval);
  TEST_ASSERT_EQUAL(1.1, get_env(&env, "one-1")->floatval);
  ...
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "two-1")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "one-4")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "one-3")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "one-2")->type);
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "one-1")->type);
...
void test_env_redefinition_error(void) {
  ...
  // Not there.
  TEST_ASSERT_EQUAL(TYPE_NIL, get_env(&env, "thing")->type);
