...
static ast_reserved_callable_type_t ast_callable_type_for_tag(tag_t tag) {
    switch (tag) {
        ...
        case TAG_ENV:
            return AST_CALL_ENV;
        case TAG_TYPEOF:
            return AST_CALL_TYPE_OF;
        case TAG_TO_HEX:
            return AST_CALL_TO_HEX;
        case TAG_TO_BIN:
            return AST_CALL_TO_BIN;
        case TAG_DUMP:
            return AST_CALL_DUMP;
        case TAG_PRINT:
            return AST_CALL_PRINT;
        case TAG_INPUT:
            return AST_CALL_INPUT;
        case TAG_READ:
            return AST_CALL_READ;
        case TAG_RAND:
            return AST_CALL_RAND;
        case TAG_ABS:
            return AST_CALL_ABS;
        case TAG_SIN:
            return AST_CALL_SIN;
