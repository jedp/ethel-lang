...
static const token_t reserved[] = {
        ...
        {TAG_THIS, .string = (char *) "this"},
        {TAG_TYPEDEF, .string = (char *) "type"},
        {TAG_TYPEOF, .string = (char *) "typeof"},
        {TAG_DATA, .string = (char *) "data"},
