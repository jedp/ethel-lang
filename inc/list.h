 ...
 */
obj_t *list_hash(obj_t *obj, obj_t *args_obj);

obj_t *list_eq(obj_t *obj, obj_t *args_obj);
obj_t *list_ne(obj_t *obj, obj_t *args_obj);

obj_t *list_len(obj_t *obj, obj_t *args_obj);
...
obj_t *list_subscript_get(obj_t *obj, obj_t *args_obj);
obj_t *list_subscript_set(obj_t *obj, obj_t *args_obj);
